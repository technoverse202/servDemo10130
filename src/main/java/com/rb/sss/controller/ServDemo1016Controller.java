...
import com.rb.sss.service.ServDemo1016Service;
import com.rb.core.rest.ConfigIdentifier;
import com.rb.core.rest.GenericApi;

@Path("/api/v1/employees")
public class ServDemo1016Controller {

    public static final Logger logger = LoggerFactory.getLogger(ServDemo1016Controller.class);
	@Inject
	ServDemo1016Service service;
